...
def main():
        scale = 4
        image1_dir = os.path.join(os.getcwd(), 'results')
        image2_dir = os.path.join(os.getcwd(), 'data/test/Urban100/resultx2')
        total_psnr = []
        total_ssim = []
        ...
        for image_path1 in path_list:
           ...
           psnr, ssim = calc_metrics(hr, sr, crop_border=scale)
           total_psnr.append(psnr)
           total_ssim.append(ssim)
          
           print("%s：PSNR(dB)/SSIM: %.2f/%.4f." %(image_name,psnr, ssim))
